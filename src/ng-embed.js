    ...
    angular.module('ngEmbed', ['ngSanitize'])
        .filter('embed', ['$sce', function ($sce) {
            var shorthands = [
              { text: ':)', emoji: 'smiley' },
              { text: ':-)', emoji: 'smiley' },
              { text: ':(', emoji: 'disappointed' },
              { text: ':-(', emoji: 'disappointed' },
              { text: ':/', emoji: 'confused' },
              { text: ':-/', emoji: 'confused' },
              { text: ':\\', emoji: 'confused' },
              { text: ':-\\', emoji: 'confused' },
              { text: ':D', emoji: 'laughing' },
              { text: ':-D', emoji: 'laughing' },
              { text: ':\'(', emoji: 'cry' },
              { text: ':\'-(', emoji: 'cry' },
              { text: ':\')', emoji: 'joy' },
              { text: ':\'-)', emoji: 'joy' },
              { text: ':p', emoji: 'stuck_out_tongue' },
              { text: ':P', emoji: 'stuck_out_tongue' },
              { text: ':-p', emoji: 'stuck_out_tongue' },
              { text: ':-P', emoji: 'stuck_out_tongue' },
              { text: ';)', emoji: 'wink' },
              { text: ';-)', emoji: 'wink' },
              { text: '-_-', emoji: 'neutral_face' },
              { text: ':|', emoji: 'neutral_face' },
              { text: ':-|', emoji: 'neutral_face' },
              { text: 'B)', emoji: 'sunglasses' },
              { text: 'B-)', emoji: 'sunglasses' },
              { text: '<3', emoji: 'heart' },
              { text: '&lt;3', emoji: 'heart' },
              { text: '</3', emoji: 'broken_heart' },
              { text: '&lt;/3', emoji: 'broken_heart' }
            ];
            ...
            return function (input, userOptions) {
                ...
                function translateShorthand(str) {

                    var a = str.split(' ');
                    angular.forEach(shorthands, function (icon) {
                ...
                input = translateShorthand(input);
